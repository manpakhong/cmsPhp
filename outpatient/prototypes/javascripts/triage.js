...
var ckeditor; var templateComboBox; var triageGcsStore; var triageTabPanel;

Ext.onReady(function() {

    var traigeTableHtml = '<table class="triageGcs">' + '<thead>' +
							'</thead>' + '<tbody>' +                         
							'</tbody>' + '</table>';
	triageTabPanel = Ext.create('Ext.TabPanel', { 
		...
		items: [             
					{	
						...
						html: '<div id="triageGraphDiv"></div>',

					}         
				],listeners:{             
					'render' : function(){
		    			console.log('1111');
		    			var a = Ext.get('triageGraphDiv');
		    			var b = $('#triageGraphDiv');
		    			//alert(a);
...
function initTriageGraph(){
	var triageGraphObj = Ext.create('Ext.chart.CartesianChart', {
	    renderTo: 'triageGraph',
	    width: 500,
	    height: 500,
	    store: triageGcsStore,
	    ...
	    series: [{
	        ...
	        type: 'line',
	        xField: 'dateTime',
	        yField: 'motorVitalityScore',
	        title: 'Motor Vitality',
	        style: {
	            smooth: false,
	            stroke: "#64ae0a",
	            fillOpacity: 0.6,
